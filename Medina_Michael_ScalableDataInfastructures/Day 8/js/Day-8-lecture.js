...
//Create something that will capitalie the FIRST letter in each string=
var ourString;
var returnString;
...
ourString = prompt("Enter string to initial cap: ");

returnString = initialCaps(ourString);
...
// Functions to do string string manipulation
...
// var myArr = string.split([seperator][, limit])
...
//main code
//console.log("The last and fist indices are "+ wheresAdam(myIndexOf));
